...
export const MAP_LIST: readonly ResolvedMapEntry[] = (
  [
    ...
    },
    {
      ...
      description:
        '「山」の字の両端を上まで伸ばした陸地を、上端の線路が一直線に貫く 29x17 の横長マップ。左上が先手の自軍・右上が後手の敵軍で、両軍とも本拠地 1 + 工場 3 + 駅 1 + 港 1(収入 6000)・初期資金 30000 の対等な立ち上がりで、1 ターン目から駅で列車砲を出せる。自軍の駅から中立の駅を挟んで敵軍の駅までが 1 本の線路でつながっており、入江の上は幅 1 マスの鉄橋になる。線路は駅から駅まで 9・端から端まで 18 あるので、移動力 15 の列車砲でも中立駅までが 1 ターンぶんの射程になる。線路を使わない地上ユニットは南岸までぐるっと回り込むしかなく、敵本拠地までの距離は歩兵で線路 20・南岸回り 46(中立駅までは 9 と 36)。中央の中立駅は森と中立都市に囲まれた高台にあり、南から上がるには幅 1 マスの川を渡ることになる(装輪車両は渡れない)。川は左右の入江をつなぐ水路でもあり、海上ユニットは川を通って敵の港へ回り込める。川より南の中央には中立の研究所 2 個・中立都市 4 個・中立港 2 個が並び、研究所は両軍とも近いほうへ歩兵で 6 ターン。中立拠点は 30 個(都市 25・研究所 2・港 2・駅 1)で、後手の敵軍は陣地の隣に中立都市が 2 個多い。',
    ...
    },
    {
      ...
      description:
        '海を隔てて南北に大きな島が 2 つ並ぶ 28x25 のマップ。北の島の真ん中が先手の自軍(本拠地 1 + 工場 3 + 空港 1 + 港 2 + 都市 3・収入 10000)、南の島の左の海岸側が後手の敵軍(本拠地 1 + 工場 3 + 空港 1 + 港 2 + 都市 8・収入 15000)で、初期資金は両軍とも 0。陸路は 1 本も無く、相手の島へ渡れるのは輸送艦と飛行ユニットだけ。中立拠点 19 個のうち 16 個は自軍側にあり、北の島では陣地を挟んで西 5 個・東 5 個に分かれている。自軍の島は西側だけが南へ細長い岬になっていて、中立の研究所 1 個と中立都市 3 個を抱えたその先端からは、海 5 マスの向こうがもう敵軍の陣地。盤面の右のやや上には研究所 2 個だけが建つ離島が浮かび、海路は自軍の港から 11・敵軍の港から 26 と自軍がずっと近い。敵軍の島に残っている中立都市は東寄りの 3 個だけで、敵軍の陣地からは歩兵で 15〜16 マス離れている。',
