...
export const MAP_LIST: readonly ResolvedMapEntry[] = (
  [
    ...
    },
    {
      ...
      description:
        '北西と南東に大きな島が斜向かいに並ぶ 28x25 のマップ。北西の島の真ん中が先手の自軍(本拠地 1 + 工場 3 + 空港 1 + 港 2 + 都市 3・収入 10000)、南東の島の西端が後手の敵軍(本拠地 1 + 工場 3 + 空港 1 + 港 2 + 都市 8・収入 15000)で、初期資金は両軍とも 0。陸路は 1 本も無く、相手の島へ渡れるのは輸送艦と飛行ユニットだけ。中立拠点 19 個のうち 16 個は自軍側にあり、北西の島では陣地を挟んで西 5 個・東 5 個に分かれている。自軍の島は西側だけが盤面の下端近くまで細長い岬になっていて、中立の研究所 1 個と中立都市 3 個を抱えたその東岸からは、右へ海 5 マスの向こうがもう敵軍の陣地。自軍の島の東端(col 19)よりさらに右には研究所 2 個だけが建つ離島が浮かび、海路は自軍の港から 7・敵軍の港から 22 と自軍がずっと近い。敵軍の島は右側が北へ長く伸びていて、残る中立都市 3 個はその腕の上。敵軍の陣地からは歩兵で 11〜15 マスあるが、自軍の艦隊からは海路 12〜14 マスで横付けできる。',
